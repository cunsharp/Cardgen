...
document.addEventListener('DOMContentLoaded', function () {
    ...
    let currentViewMode = 'front'; // 'front', 'back', or 'both'
    ...
    function setViewMode(mode) {
        ...
        [viewFrontBtn, viewFrontBtn, viewBackBtn].forEach(btn => {
            if (btn) btn.classList.remove('active');
        });

        if (mode === 'front' && viewFrontBtn) viewFrontBtn.classList.add('');
        if (mode === 'back' && viewBackBtn) viewBackBtn.classList.add('');
